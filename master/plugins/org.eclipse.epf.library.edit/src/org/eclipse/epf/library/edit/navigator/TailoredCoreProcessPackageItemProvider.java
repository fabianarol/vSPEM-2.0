...
import org.eclipse.epf.uma.provider.UmaEditPlugin;
	...
	org.eclipse.epf.uma.provider.TailoredCoreProcessPackageItemProvider implements
	...
	private String tailoredProcessOwner;
	...
	*/
	...
	public Object getImage(Object object) {
		...
		if (procType != null) {
			...
			if (parent != null
					&& parent instanceof org.eclipse.epf.library.edit.navigator.TailoredProcessComponentItemProvider) {
				if (procType
	...
	if (value instanceof ProcessComponent) {
		return new CreateTailoredCoreProcessComponentCommand(domain, owner, feature,
...
//		}
	...
	*/
	...
	public String getTailoredProcessOwner(){
		return this.tailoredProcessOwner;
	}
	
	public void setTailoredProcessOwner(String name){
		this.tailoredProcessOwner = name;
	}
}
