...
public abstract class AbstractTailoredProcessItemProvider extends ItemProviderAdapter
	...
	public AbstractTailoredProcessItemProvider(AdapterFactory adapterFactory,
	...
	public Object getImage(Object object) {
		return LibraryEditPlugin.INSTANCE.getImage("full/obj16/TailoredProcessPackage"); //$NON-NLS-1$
	}
	
	public String getText(Object object) {
		return LibraryEditPlugin.INSTANCE.getString("_UI_Tailored_Process_Package_group"); //$NON-NLS-1$
	}
