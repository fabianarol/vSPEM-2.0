...
public abstract class AbstractProcessLinesItemProvider extends ItemProviderAdapter
	...
	public AbstractProcessLinesItemProvider(AdapterFactory adapterFactory,
	...
	public Object getImage(Object object) {
		return LibraryEditPlugin.INSTANCE.getImage("full/obj16/ProcessLinesPackage"); //$NON-NLS-1$
	}
	
	public String getText(Object object) {
		return LibraryEditPlugin.INSTANCE.getString("_UI_Process_Lines_Package_group"); //$NON-NLS-1$
	}
