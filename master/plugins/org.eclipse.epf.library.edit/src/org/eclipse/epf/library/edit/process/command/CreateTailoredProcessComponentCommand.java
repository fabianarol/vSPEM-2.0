...
public class CreateTailoredProcessComponentCommand extends CreateChildCommand {
	...
	public void execute() {
		...
		for (Iterator iter = configs.iterator(); iter.hasNext();) {
			...
			//Si no es instancia de ProcessFamily, nuestros procesos adaptados no van a pertenecer a ninguna familia - Añado nuestro objeto a la configuracion
		...
		MethodPlugin plugin = UmaUtil.getMethodPlugin((Element) owner);//FIXME Coje de plugin la Linea A, en teoría es asi como debería de ser
