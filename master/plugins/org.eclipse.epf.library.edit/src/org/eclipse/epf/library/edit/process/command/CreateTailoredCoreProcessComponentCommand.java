...
public class CreateTailoredCoreProcessComponentCommand extends CreateChildCommand {
	 ...
	 */
	public CreateTailoredCoreProcessComponentCommand(EditingDomain domain, EObject owner,
