 ...
 * @since 1.0
 */
public class NewProcessLineMainPage extends BaseWizardPage {

	/**
	 * The wizard page name.
	 */
	public static final String PAGE_NAME = NewProcessLineMainPage.class.getName();
	 ...
	 */
	public NewProcessLineMainPage() {
		super(PAGE_NAME);
		setTitle(AuthoringUIResources.newProcessLineWizardMainPage_title);
		setDescription(AuthoringUIResources.newProcessLineWizardMainPage_description);
