 ...
 * @since 1.0
 */
public class NewProcessLineWizard extends Wizard implements INewWizard {

	/**
	 * The wizard ID.
	 */
	public static final String WIZARD_ID = NewProcessLineWizard.class.getName();

	// The main wizard page.
	private NewProcessLineMainPage mainPage;

	/**
	 * Creates a new instance.
	 */
	public NewProcessLineWizard() {
		super();
	}
	...
	public void init(IWorkbench workbench, IStructuredSelection selection) {
		setWindowTitle(AuthoringUIResources.newProcessLineWizard_title);
	}
	...
	public void addPages() {
		...
		mainPage = new NewProcessLineMainPage();
		addPage(mainPage);
	}
