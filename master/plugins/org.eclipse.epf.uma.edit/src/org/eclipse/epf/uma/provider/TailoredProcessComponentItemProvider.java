...
/**
 * This is the item provider adapter for a {@link org.eclipse.epf.uma.TailoredProcessComponent} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TailoredProcessComponentItemProvider extends
		TailoredProcessesPackageItemProvider implements
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						((ComposeableAdapterFactory) adapterFactory)
								.getRootAdapterFactory(),
						getResourceLocator(),
						getString("_UI_TailoredProcessComponent_interfaces_feature"), //$NON-NLS-1$
						getString(
								"_UI_PropertyDescriptor_description", "_UI_TailoredProcessComponent_interfaces_feature", "_UI_TailoredProcessComponent_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						UmaPackage.Literals.TAILORED_PROCESS_COMPONENT__INTERFACES,
						true, false, true, null, null, null));
	}
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures
					.add(UmaPackage.Literals.TAILORED_PROCESS_COMPONENT__ATRAVESDE);
			childrenFeatures
					.add(UmaPackage.Literals.TAILORED_PROCESS_COMPONENT__OCCUPATIONS);
			childrenFeatures
					.add(UmaPackage.Literals.TAILORED_PROCESS_COMPONENT__TAILORED_PROCESS);
		}
	...
	/**
	 * This returns TailoredProcessComponent.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage(
				"full/obj16/TailoredProcessComponent")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((TailoredProcessComponent) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_TailoredProcessComponent_type") : //$NON-NLS-1$
				getString("_UI_TailoredProcessComponent_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors,
		...
		newChildDescriptors.add(createChildParameter(
				UmaPackage.Literals.TAILORED_PROCESS_COMPONENT__ATRAVESDE,
				UmaFactory.eINSTANCE.createProcAspect()));

		newChildDescriptors.add(createChildParameter(
				UmaPackage.Literals.TAILORED_PROCESS_COMPONENT__ATRAVESDE,
				UmaFactory.eINSTANCE.createVariation()));

		newChildDescriptors.add(createChildParameter(
				UmaPackage.Literals.TAILORED_PROCESS_COMPONENT__ATRAVESDE,
				UmaFactory.eINSTANCE.createOccupation()));

		newChildDescriptors.add(createChildParameter(
				UmaPackage.Literals.TAILORED_PROCESS_COMPONENT__OCCUPATIONS,
				UmaFactory.eINSTANCE.createOccupation()));

		newChildDescriptors
				.add(createChildParameter(
						UmaPackage.Literals.TAILORED_PROCESS_COMPONENT__TAILORED_PROCESS,
	...
	public String getCreateChildText(Object owner, Object feature,
		...
		boolean qualify = childFeature == UmaPackage.Literals.METHOD_PACKAGE__CHILD_PACKAGES
				|| childFeature == UmaPackage.Literals.METHOD_PLUGIN__METHOD_PACKAGES
				|| childFeature == UmaPackage.Literals.TAILORED_PROCESS_COMPONENT__ATRAVESDE
				|| childFeature == UmaPackage.Literals.TAILORED_PROCESS_COMPONENT__OCCUPATIONS;
