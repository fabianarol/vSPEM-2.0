...
/**
 * This is the item provider adapter for a {@link org.eclipse.epf.uma.vpWorkProductDescriptor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class vpWorkProductDescriptorItemProvider extends
		WorkProductDescriptorItemProvider implements
	 ...
	 * @generated
	 */
	public vpWorkProductDescriptorItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns vpWorkProductDescriptor.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage(
				"full/obj16/vpWorkProductDescriptor")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((vpWorkProductDescriptor) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_vpWorkProductDescriptor_type") : //$NON-NLS-1$
				getString("_UI_vpWorkProductDescriptor_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(vpWorkProductDescriptor.class)) {
