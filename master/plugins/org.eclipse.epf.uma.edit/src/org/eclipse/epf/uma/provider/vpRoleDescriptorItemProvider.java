...
/**
 * This is the item provider adapter for a {@link org.eclipse.epf.uma.vpRoleDescriptor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class vpRoleDescriptorItemProvider extends RoleDescriptorItemProvider
	...
	/**
	 * This returns vpRoleDescriptor.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage(
				"full/obj16/vpRoleDescriptor")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((vpRoleDescriptor) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_vpRoleDescriptor_type") : //$NON-NLS-1$
				getString("_UI_vpRoleDescriptor_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(vpRoleDescriptor.class)) {
