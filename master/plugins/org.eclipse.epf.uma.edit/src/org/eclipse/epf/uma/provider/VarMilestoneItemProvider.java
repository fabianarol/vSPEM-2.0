...
/**
 * This is the item provider adapter for a {@link org.eclipse.epf.uma.VarMilestone} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VarMilestoneItemProvider extends MilestoneItemProvider implements
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage(
				"full/obj16/VarMilestone")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((VarMilestone) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_VarMilestone_type") : //$NON-NLS-1$
				getString("_UI_VarMilestone_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VarMilestone.class)) {
