...
/**
 * This is the item provider adapter for a {@link org.eclipse.epf.uma.VarWorkProductDescriptor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VarWorkProductDescriptorItemProvider extends
	 ...
	 * @generated
	 */
	public VarWorkProductDescriptorItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns VarWorkProductDescriptor.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage(
				"full/obj16/VarWorkProductDescriptor")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((VarWorkProductDescriptor) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_VarWorkProductDescriptor_type") : //$NON-NLS-1$
				getString("_UI_VarWorkProductDescriptor_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VarWorkProductDescriptor.class)) {
