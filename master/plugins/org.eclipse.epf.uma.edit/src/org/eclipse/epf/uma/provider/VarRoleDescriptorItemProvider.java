...
/**
 * This is the item provider adapter for a {@link org.eclipse.epf.uma.VarRoleDescriptor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VarRoleDescriptorItemProvider extends RoleDescriptorItemProvider
	...
	/**
	 * This returns VarRoleDescriptor.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage(
				"full/obj16/VarRoleDescriptor")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((VarRoleDescriptor) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_VarRoleDescriptor_type") : //$NON-NLS-1$
				getString("_UI_VarRoleDescriptor_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VarRoleDescriptor.class)) {
