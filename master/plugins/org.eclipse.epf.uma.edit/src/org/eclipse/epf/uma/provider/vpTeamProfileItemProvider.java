...
/**
 * This is the item provider adapter for a {@link org.eclipse.epf.uma.vpTeamProfile} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class vpTeamProfileItemProvider extends TeamProfileItemProvider
	...
	/**
	 * This returns vpTeamProfile.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage(
				"full/obj16/vpTeamProfile")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((vpTeamProfile) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_vpTeamProfile_type") : //$NON-NLS-1$
				getString("_UI_vpTeamProfile_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(vpTeamProfile.class)) {
