...
/**
 * This is the item provider adapter for a {@link org.eclipse.epf.uma.vpIteration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class vpIterationItemProvider extends IterationItemProvider implements
	 ...
	 * @generated
	 */
	public vpIterationItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage(
				"full/obj16/vpIteration")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((vpIteration) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_vpIteration_type") : //$NON-NLS-1$
				getString("_UI_vpIteration_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(vpIteration.class)) {
	...
	public String getCreateChildText(Object owner, Object feature,
		...
		boolean qualify = childFeature == UmaPackage.Literals.METHOD_ELEMENT__OWNED_RULES
				...
				|| childFeature == UmaPackage.Literals.VAR_ELEMENT__CLIENT
