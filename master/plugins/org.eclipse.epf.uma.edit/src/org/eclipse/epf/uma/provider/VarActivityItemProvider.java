...
/**
 * This is the item provider adapter for a {@link org.eclipse.epf.uma.VarActivity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VarActivityItemProvider extends ActivityItemProvider implements
	 ...
	 * @generated
	 */
	public VarActivityItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage(
				"full/obj16/VarActivity")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((VarActivity) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_VarActivity_type") : //$NON-NLS-1$
				getString("_UI_VarActivity_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VarActivity.class)) {
