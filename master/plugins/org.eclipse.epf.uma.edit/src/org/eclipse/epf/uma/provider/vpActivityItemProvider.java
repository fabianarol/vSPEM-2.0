...
/**
 * This is the item provider adapter for a {@link org.eclipse.epf.uma.vpActivity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class vpActivityItemProvider extends ActivityItemProvider implements
	 ...
	 * @generated
	 */
	public vpActivityItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage(
				"full/obj16/vpActivity")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((vpActivity) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_vpActivity_type") : //$NON-NLS-1$
				getString("_UI_vpActivity_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(vpActivity.class)) {
