...
/**
 * This is the item provider adapter for a {@link org.eclipse.epf.uma.VarIteration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VarIterationItemProvider extends IterationItemProvider implements
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage(
				"full/obj16/VarIteration")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((VarIteration) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_VarIteration_type") : //$NON-NLS-1$
				getString("_UI_VarIteration_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VarIteration.class)) {
