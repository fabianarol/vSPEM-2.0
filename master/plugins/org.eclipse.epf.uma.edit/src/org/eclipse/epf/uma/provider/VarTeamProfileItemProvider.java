...
/**
 * This is the item provider adapter for a {@link org.eclipse.epf.uma.VarTeamProfile} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VarTeamProfileItemProvider extends TeamProfileItemProvider
	 ...
	 * @generated
	 */
	public VarTeamProfileItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns VarTeamProfile.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage(
				"full/obj16/VarTeamProfile")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((VarTeamProfile) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_VarTeamProfile_type") : //$NON-NLS-1$
				getString("_UI_VarTeamProfile_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VarTeamProfile.class)) {
