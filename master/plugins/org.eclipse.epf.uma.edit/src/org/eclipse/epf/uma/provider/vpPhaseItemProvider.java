...
/**
 * This is the item provider adapter for a {@link org.eclipse.epf.uma.vpPhase} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class vpPhaseItemProvider extends PhaseItemProvider implements
	 ...
	 * @generated
	 */
	public vpPhaseItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((vpPhase) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_vpPhase_type") : //$NON-NLS-1$
				getString("_UI_vpPhase_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(vpPhase.class)) {
