...
/**
 * This is the item provider adapter for a {@link org.eclipse.epf.uma.VarPhase} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VarPhaseItemProvider extends PhaseItemProvider implements
	 ...
	 * @generated
	 */
	public VarPhaseItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((VarPhase) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_VarPhase_type") : //$NON-NLS-1$
				getString("_UI_VarPhase_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VarPhase.class)) {
