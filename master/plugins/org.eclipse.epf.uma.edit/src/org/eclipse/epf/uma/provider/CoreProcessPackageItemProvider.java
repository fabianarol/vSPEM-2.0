...
/**
 * This is the item provider adapter for a {@link org.eclipse.epf.uma.CoreProcessPackage} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CoreProcessPackageItemProvider extends MethodPackageItemProvider
	...
	protected void addLineNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(
						...
						getResourceLocator(),
						getString("_UI_CoreProcessPackage_lineName_feature"), //$NON-NLS-1$
						getString(
								"_UI_PropertyDescriptor_description", "_UI_CoreProcessPackage_lineName_feature", "_UI_CoreProcessPackage_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						UmaPackage.Literals.CORE_PROCESS_PACKAGE__LINE_NAME,
						true, false, false,
	...
	/**
	 * This returns CoreProcessPackage.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage(
				"full/obj16/CoreProcessPackage")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((CoreProcessPackage) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_CoreProcessPackage_type") : //$NON-NLS-1$
				getString("_UI_CoreProcessPackage_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(CoreProcessPackage.class)) {
