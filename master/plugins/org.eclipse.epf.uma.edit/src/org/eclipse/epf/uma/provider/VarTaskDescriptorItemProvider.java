...
/**
 * This is the item provider adapter for a {@link org.eclipse.epf.uma.VarTaskDescriptor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VarTaskDescriptorItemProvider extends TaskDescriptorItemProvider
	...
	/**
	 * This returns VarTaskDescriptor.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage(
				"full/obj16/VarTaskDescriptor")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((VarTaskDescriptor) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_VarTaskDescriptor_type") : //$NON-NLS-1$
				getString("_UI_VarTaskDescriptor_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VarTaskDescriptor.class)) {
