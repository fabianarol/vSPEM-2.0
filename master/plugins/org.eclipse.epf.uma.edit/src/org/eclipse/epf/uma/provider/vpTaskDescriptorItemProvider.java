...
/**
 * This is the item provider adapter for a {@link org.eclipse.epf.uma.vpTaskDescriptor} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class vpTaskDescriptorItemProvider extends TaskDescriptorItemProvider
	 ...
	 * @generated
	 */
	public vpTaskDescriptorItemProvider(AdapterFactory adapterFactory) {
	...
	/**
	 * This returns vpTaskDescriptor.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage(
				"full/obj16/vpTaskDescriptor")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		String label = ((vpTaskDescriptor) object).getName();
		return label == null || label.length() == 0 ? getString("_UI_vpTaskDescriptor_type") : //$NON-NLS-1$
				getString("_UI_vpTaskDescriptor_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(vpTaskDescriptor.class)) {
