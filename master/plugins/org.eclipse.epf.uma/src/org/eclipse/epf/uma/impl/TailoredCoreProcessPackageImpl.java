...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Tailored Core Process Package</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipse.epf.uma.impl.TailoredCoreProcessPackageImpl#getProcessElements <em>Process Elements</em>}</li>
 *   <li>{@link org.eclipse.epf.uma.impl.TailoredCoreProcessPackageImpl#getDiagrams <em>Diagrams</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class TailoredCoreProcessPackageImpl extends MethodPackageImpl implements
		TailoredCoreProcessPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	protected TailoredCoreProcessPackageImpl() {
		super();
	...
	protected EClass eStaticClass() {
		return UmaPackage.Literals.TAILORED_CORE_PROCESS_PACKAGE;
	}
	...
	public List getProcessElements() {
		if (processElements == null) {
			processElements = new EObjectContainmentEList.Resolving(
					...
					UmaPackage.TAILORED_CORE_PROCESS_PACKAGE__PROCESS_ELEMENTS);
		}
	...
	public List getDiagrams() {
		if (diagrams == null) {
			diagrams = new EObjectContainmentEList.Resolving(Diagram.class,
					this, UmaPackage.TAILORED_CORE_PROCESS_PACKAGE__DIAGRAMS);
		}
		return diagrams;
	}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class baseClass) {
		if (baseClass == ProcessPackage.class) {
			...
			case UmaPackage.PROCESS_PACKAGE__PROCESS_ELEMENTS:
				return UmaPackage.TAILORED_CORE_PROCESS_PACKAGE__PROCESS_ELEMENTS;
			case UmaPackage.PROCESS_PACKAGE__DIAGRAMS:
				return UmaPackage.TAILORED_CORE_PROCESS_PACKAGE__DIAGRAMS;
			default:
				return -1;
			}
		}
...
} //TailoredCoreProcessPackageImpl