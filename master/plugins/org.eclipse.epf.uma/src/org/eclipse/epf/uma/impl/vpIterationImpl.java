...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>vp Iteration</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipse.epf.uma.impl.vpIterationImpl#getVpName <em>Vp Name</em>}</li>
 *   <li>{@link org.eclipse.epf.uma.impl.vpIterationImpl#getVId <em>VId</em>}</li>
 *   <li>{@link org.eclipse.epf.uma.impl.vpIterationImpl#getPathIcon <em>Path Icon</em>}</li>
 *   <li>{@link org.eclipse.epf.uma.impl.vpIterationImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.eclipse.epf.uma.impl.vpIterationImpl#getClient <em>Client</em>}</li>
 *   <li>{@link org.eclipse.epf.uma.impl.vpIterationImpl#getSupplier <em>Supplier</em>}</li>
 *   <li>{@link org.eclipse.epf.uma.impl.vpIterationImpl#isIsImplicit <em>Is Implicit</em>}</li>
 *   <li>{@link org.eclipse.epf.uma.impl.vpIterationImpl#isIsOpen <em>Is Open</em>}</li>
 *   <li>{@link org.eclipse.epf.uma.impl.vpIterationImpl#getMin <em>Min</em>}</li>
 *   <li>{@link org.eclipse.epf.uma.impl.vpIterationImpl#getMax <em>Max</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class vpIterationImpl extends IterationImpl implements vpIteration {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected EClass eStaticClass() {
		return UmaPackage.Literals.VP_ITERATION;
	}
	...
	public void setVpName(String newVpName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UmaPackage.VP_ITERATION__VP_NAME, oldVpName, vpName));
	}
	...
	public void setVId(String newVId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UmaPackage.VP_ITERATION__VID, oldVId, vId));
	}
	...
	public void setPathIcon(String newPathIcon) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UmaPackage.VP_ITERATION__PATH_ICON, oldPathIcon, pathIcon));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UmaPackage.VP_ITERATION__DESCRIPTION, oldDescription,
					description));
	}
	...
	public List getClient() {
		if (client == null) {
			client = new EObjectContainmentEList.Resolving(Dependences.class,
					this, UmaPackage.VP_ITERATION__CLIENT);
		}
		return client;
	}
	...
	public List getSupplier() {
		if (supplier == null) {
			supplier = new EObjectContainmentEList.Resolving(Dependences.class,
					this, UmaPackage.VP_ITERATION__SUPPLIER);
		}
		return supplier;
	}
	...
	public void setIsImplicit(boolean newIsImplicit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UmaPackage.VP_ITERATION__IS_IMPLICIT, oldIsImplicit,
					isImplicit));
	}
	...
	public void setIsOpen(boolean newIsOpen) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UmaPackage.VP_ITERATION__IS_OPEN, oldIsOpen, isOpen));
	}
	...
	public void setMin(int newMin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UmaPackage.VP_ITERATION__MIN, oldMin, min));
	}
	...
	public void setMax(int newMax) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UmaPackage.VP_ITERATION__MAX, oldMax, max));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case UmaPackage.VP_ITERATION__CLIENT:
			return ((InternalEList) getClient()).basicRemove(otherEnd, msgs);
		case UmaPackage.VP_ITERATION__SUPPLIER:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case UmaPackage.VP_ITERATION__VP_NAME:
			return getVpName();
		case UmaPackage.VP_ITERATION__VID:
			return getVId();
		case UmaPackage.VP_ITERATION__PATH_ICON:
			return getPathIcon();
		case UmaPackage.VP_ITERATION__DESCRIPTION:
			return getDescription();
		case UmaPackage.VP_ITERATION__CLIENT:
			return getClient();
		case UmaPackage.VP_ITERATION__SUPPLIER:
			return getSupplier();
		case UmaPackage.VP_ITERATION__IS_IMPLICIT:
			return isIsImplicit() ? Boolean.TRUE : Boolean.FALSE;
		case UmaPackage.VP_ITERATION__IS_OPEN:
			return isIsOpen() ? Boolean.TRUE : Boolean.FALSE;
		case UmaPackage.VP_ITERATION__MIN:
			return new Integer(getMin());
		case UmaPackage.VP_ITERATION__MAX:
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class baseClass) {
		if (baseClass == VarElement.class) {
			...
			case UmaPackage.VAR_ELEMENT__VP_NAME:
				return UmaPackage.VP_ITERATION__VP_NAME;
			case UmaPackage.VAR_ELEMENT__VID:
				return UmaPackage.VP_ITERATION__VID;
			case UmaPackage.VAR_ELEMENT__PATH_ICON:
				return UmaPackage.VP_ITERATION__PATH_ICON;
			case UmaPackage.VAR_ELEMENT__DESCRIPTION:
				return UmaPackage.VP_ITERATION__DESCRIPTION;
			case UmaPackage.VAR_ELEMENT__CLIENT:
				return UmaPackage.VP_ITERATION__CLIENT;
			case UmaPackage.VAR_ELEMENT__SUPPLIER:
				return UmaPackage.VP_ITERATION__SUPPLIER;
			default:
				return -1;
			}
		}
		if (baseClass == VarPoint.class) {
			...
			case UmaPackage.VAR_POINT__IS_IMPLICIT:
				return UmaPackage.VP_ITERATION__IS_IMPLICIT;
			case UmaPackage.VAR_POINT__IS_OPEN:
				return UmaPackage.VP_ITERATION__IS_OPEN;
			case UmaPackage.VAR_POINT__MIN:
				return UmaPackage.VP_ITERATION__MIN;
			case UmaPackage.VAR_POINT__MAX:
				return UmaPackage.VP_ITERATION__MAX;
			default:
				return -1;
			}
		}
