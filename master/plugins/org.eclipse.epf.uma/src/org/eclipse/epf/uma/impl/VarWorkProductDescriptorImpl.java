...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Var Work Product Descriptor</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipse.epf.uma.impl.VarWorkProductDescriptorImpl#getVpName <em>Vp Name</em>}</li>
 *   <li>{@link org.eclipse.epf.uma.impl.VarWorkProductDescriptorImpl#getVId <em>VId</em>}</li>
 *   <li>{@link org.eclipse.epf.uma.impl.VarWorkProductDescriptorImpl#getPathIcon <em>Path Icon</em>}</li>
 *   <li>{@link org.eclipse.epf.uma.impl.VarWorkProductDescriptorImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.eclipse.epf.uma.impl.VarWorkProductDescriptorImpl#getClient <em>Client</em>}</li>
 *   <li>{@link org.eclipse.epf.uma.impl.VarWorkProductDescriptorImpl#getSupplier <em>Supplier</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class VarWorkProductDescriptorImpl extends WorkProductDescriptorImpl
		implements VarWorkProductDescriptor {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @generated
	 */
	protected VarWorkProductDescriptorImpl() {
		super();
	...
	protected EClass eStaticClass() {
		return UmaPackage.Literals.VAR_WORK_PRODUCT_DESCRIPTOR;
	}
	...
	public void setVpName(String newVpName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UmaPackage.VAR_WORK_PRODUCT_DESCRIPTOR__VP_NAME, oldVpName,
					vpName));
	}
	...
	public void setVId(String newVId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UmaPackage.VAR_WORK_PRODUCT_DESCRIPTOR__VID, oldVId, vId));
	}
	...
	public void setPathIcon(String newPathIcon) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UmaPackage.VAR_WORK_PRODUCT_DESCRIPTOR__PATH_ICON,
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UmaPackage.VAR_WORK_PRODUCT_DESCRIPTOR__DESCRIPTION,
	...
	public List getClient() {
		if (client == null) {
			client = new EObjectContainmentEList.Resolving(Dependences.class,
					this, UmaPackage.VAR_WORK_PRODUCT_DESCRIPTOR__CLIENT);
		}
		return client;
	}
	...
	public List getSupplier() {
		if (supplier == null) {
			supplier = new EObjectContainmentEList.Resolving(Dependences.class,
					this, UmaPackage.VAR_WORK_PRODUCT_DESCRIPTOR__SUPPLIER);
		}
		return supplier;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case UmaPackage.VAR_WORK_PRODUCT_DESCRIPTOR__CLIENT:
			return ((InternalEList) getClient()).basicRemove(otherEnd, msgs);
		case UmaPackage.VAR_WORK_PRODUCT_DESCRIPTOR__SUPPLIER:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case UmaPackage.VAR_WORK_PRODUCT_DESCRIPTOR__VP_NAME:
			return getVpName();
		case UmaPackage.VAR_WORK_PRODUCT_DESCRIPTOR__VID:
			return getVId();
		case UmaPackage.VAR_WORK_PRODUCT_DESCRIPTOR__PATH_ICON:
			return getPathIcon();
		case UmaPackage.VAR_WORK_PRODUCT_DESCRIPTOR__DESCRIPTION:
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class baseClass) {
		...
		if (baseClass == VarElement.class) {
			...
			case UmaPackage.VAR_ELEMENT__VP_NAME:
				return UmaPackage.VAR_WORK_PRODUCT_DESCRIPTOR__VP_NAME;
			case UmaPackage.VAR_ELEMENT__VID:
				return UmaPackage.VAR_WORK_PRODUCT_DESCRIPTOR__VID;
			case UmaPackage.VAR_ELEMENT__PATH_ICON:
				return UmaPackage.VAR_WORK_PRODUCT_DESCRIPTOR__PATH_ICON;
			case UmaPackage.VAR_ELEMENT__DESCRIPTION:
				return UmaPackage.VAR_WORK_PRODUCT_DESCRIPTOR__DESCRIPTION;
			case UmaPackage.VAR_ELEMENT__CLIENT:
				return UmaPackage.VAR_WORK_PRODUCT_DESCRIPTOR__CLIENT;
			case UmaPackage.VAR_ELEMENT__SUPPLIER:
				return UmaPackage.VAR_WORK_PRODUCT_DESCRIPTOR__SUPPLIER;
			default:
				return -1;
			}
		}
