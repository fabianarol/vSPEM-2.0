...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>vp Task Descriptor</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipse.epf.uma.impl.vpTaskDescriptorImpl#getVpName <em>Vp Name</em>}</li>
 *   <li>{@link org.eclipse.epf.uma.impl.vpTaskDescriptorImpl#getVId <em>VId</em>}</li>
 *   <li>{@link org.eclipse.epf.uma.impl.vpTaskDescriptorImpl#getPathIcon <em>Path Icon</em>}</li>
 *   <li>{@link org.eclipse.epf.uma.impl.vpTaskDescriptorImpl#getDescription <em>Description</em>}</li>
 *   <li>{@link org.eclipse.epf.uma.impl.vpTaskDescriptorImpl#getClient <em>Client</em>}</li>
 *   <li>{@link org.eclipse.epf.uma.impl.vpTaskDescriptorImpl#getSupplier <em>Supplier</em>}</li>
 *   <li>{@link org.eclipse.epf.uma.impl.vpTaskDescriptorImpl#isIsImplicit <em>Is Implicit</em>}</li>
 *   <li>{@link org.eclipse.epf.uma.impl.vpTaskDescriptorImpl#isIsOpen <em>Is Open</em>}</li>
 *   <li>{@link org.eclipse.epf.uma.impl.vpTaskDescriptorImpl#getMin <em>Min</em>}</li>
 *   <li>{@link org.eclipse.epf.uma.impl.vpTaskDescriptorImpl#getMax <em>Max</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class vpTaskDescriptorImpl extends TaskDescriptorImpl implements
		vpTaskDescriptor {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	protected vpTaskDescriptorImpl() {
		super();
	...
	protected EClass eStaticClass() {
		return UmaPackage.Literals.VP_TASK_DESCRIPTOR;
	}
	...
	public void setVpName(String newVpName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UmaPackage.VP_TASK_DESCRIPTOR__VP_NAME, oldVpName, vpName));
	}
	...
	public void setVId(String newVId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UmaPackage.VP_TASK_DESCRIPTOR__VID, oldVId, vId));
	}
	...
	public void setPathIcon(String newPathIcon) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UmaPackage.VP_TASK_DESCRIPTOR__PATH_ICON, oldPathIcon,
					pathIcon));
	}
	...
	public void setDescription(String newDescription) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UmaPackage.VP_TASK_DESCRIPTOR__DESCRIPTION, oldDescription,
					description));
	}
	...
	public List getClient() {
		if (client == null) {
			client = new EObjectContainmentEList.Resolving(Dependences.class,
					this, UmaPackage.VP_TASK_DESCRIPTOR__CLIENT);
		}
		return client;
	}
	...
	public List getSupplier() {
		if (supplier == null) {
			supplier = new EObjectContainmentEList.Resolving(Dependences.class,
					this, UmaPackage.VP_TASK_DESCRIPTOR__SUPPLIER);
		}
		return supplier;
	}
	...
	public void setIsImplicit(boolean newIsImplicit) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UmaPackage.VP_TASK_DESCRIPTOR__IS_IMPLICIT, oldIsImplicit,
					isImplicit));
	}
	...
	public void setIsOpen(boolean newIsOpen) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UmaPackage.VP_TASK_DESCRIPTOR__IS_OPEN, oldIsOpen, isOpen));
	}
	...
	public void setMin(int newMin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UmaPackage.VP_TASK_DESCRIPTOR__MIN, oldMin, min));
	}
	...
	public void setMax(int newMax) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					UmaPackage.VP_TASK_DESCRIPTOR__MAX, oldMax, max));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case UmaPackage.VP_TASK_DESCRIPTOR__CLIENT:
			return ((InternalEList) getClient()).basicRemove(otherEnd, msgs);
		case UmaPackage.VP_TASK_DESCRIPTOR__SUPPLIER:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case UmaPackage.VP_TASK_DESCRIPTOR__VP_NAME:
			return getVpName();
		case UmaPackage.VP_TASK_DESCRIPTOR__VID:
			return getVId();
		case UmaPackage.VP_TASK_DESCRIPTOR__PATH_ICON:
			return getPathIcon();
		case UmaPackage.VP_TASK_DESCRIPTOR__DESCRIPTION:
			return getDescription();
		case UmaPackage.VP_TASK_DESCRIPTOR__CLIENT:
			return getClient();
		case UmaPackage.VP_TASK_DESCRIPTOR__SUPPLIER:
			return getSupplier();
		case UmaPackage.VP_TASK_DESCRIPTOR__IS_IMPLICIT:
			return isIsImplicit() ? Boolean.TRUE : Boolean.FALSE;
		case UmaPackage.VP_TASK_DESCRIPTOR__IS_OPEN:
			return isIsOpen() ? Boolean.TRUE : Boolean.FALSE;
		case UmaPackage.VP_TASK_DESCRIPTOR__MIN:
			return new Integer(getMin());
		case UmaPackage.VP_TASK_DESCRIPTOR__MAX:
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class baseClass) {
		...
		if (baseClass == VarElement.class) {
			...
			case UmaPackage.VAR_ELEMENT__VP_NAME:
				return UmaPackage.VP_TASK_DESCRIPTOR__VP_NAME;
			case UmaPackage.VAR_ELEMENT__VID:
				return UmaPackage.VP_TASK_DESCRIPTOR__VID;
			case UmaPackage.VAR_ELEMENT__PATH_ICON:
				return UmaPackage.VP_TASK_DESCRIPTOR__PATH_ICON;
			case UmaPackage.VAR_ELEMENT__DESCRIPTION:
				return UmaPackage.VP_TASK_DESCRIPTOR__DESCRIPTION;
			case UmaPackage.VAR_ELEMENT__CLIENT:
				return UmaPackage.VP_TASK_DESCRIPTOR__CLIENT;
			case UmaPackage.VAR_ELEMENT__SUPPLIER:
				return UmaPackage.VP_TASK_DESCRIPTOR__SUPPLIER;
			default:
				return -1;
			}
		}
		if (baseClass == VarPoint.class) {
			...
			case UmaPackage.VAR_POINT__IS_IMPLICIT:
				return UmaPackage.VP_TASK_DESCRIPTOR__IS_IMPLICIT;
			case UmaPackage.VAR_POINT__IS_OPEN:
				return UmaPackage.VP_TASK_DESCRIPTOR__IS_OPEN;
			case UmaPackage.VAR_POINT__MIN:
				return UmaPackage.VP_TASK_DESCRIPTOR__MIN;
			case UmaPackage.VAR_POINT__MAX:
				return UmaPackage.VP_TASK_DESCRIPTOR__MAX;
			default:
				return -1;
			}
		}
